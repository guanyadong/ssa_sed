...
def generate_tsv_wav_durations(audio_dir, out_tsv):
    ...
    for file in glob.glob("/data/guanyadong/experiment/dcase20_task4_normalversion_gyd_various_media_window_mixup_timeshift_freqshift_nonoise_best4793/dataset/audio/eval/eval1/*.wav"):
...
def get_durations_df(gtruth_path, audio_dir=None):
    ...
    if not os.path.exists(path_durations_synth):
        ...
        durations_df = generate_tsv_wav_durations('../../dataset/audio/eval/eval1', path_durations_synth)
    else:
...
def do_mixup(x, mixup_lambda):
    ...
    Return:
      out: (N, ...)
    """
    # print(mixup_lambda[0 :: 2])
    # output1 = x[0:: 2].transpose(0, -1) * mixup_lambda[0:: 2]
    # output2 = x[1:: 2].transpose(0, -1) * mixup_lambda[1:: 2]
    # print(mixup_lambda.shape)
    output = x[0 :: 2].transpose(0, -1) * mixup_lambda[0 :: 2] + x[1 :: 2].transpose(0, -1) * mixup_lambda[1 :: 2]
    # print(output1.shape)
    # print(output2.shape)
